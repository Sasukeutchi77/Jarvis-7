...
export function Sidebar() {
  ...
  const navItems = [
    ...
    { path: '/audit', icon: ShieldCheck, label: 'Audit & Optimisation' },
    { path: '/communications', icon: MessageCircle, label: 'Messages & Notifs' },
    { path: '/shortcuts', icon: BrainCircuit, label: 'Raccourcis & Habitudes' },
    { path: '/tasks', icon: CalendarClock, label: 'Tâches & Superviseur' },
    { path: '/diagnostics', icon: Activity, label: 'Auto-Diagnostic' },
    { path: '/macros', icon: Sparkles, label: 'Mots-Clés Vocaux' },
    { path: '/automations', icon: Zap, label: 'Automatisations IF/THEN' },
    { path: '/context', icon: Compass, label: 'Moteur de Contexte' },
    { path: '/proactive', icon: Compass, label: 'JARVIS Proactif' },
    { path: '/android', icon: Smartphone, label: 'Android Hub' },
    { path: '/smart-home', icon: Home, label: 'Domotique' },
    { path: '/routines', icon: Zap, label: 'Routines' },
    { path: '/security', icon: Shield, label: 'Sécurité & Gouvernance' },
    { path: '/vision', icon: Eye, label: 'Vision & Caméra' },
    { path: '/search', icon: Globe, label: 'Recherche Web' },
    { path: '/dashboard', icon: BarChart3, label: 'Dashboard' },
    { path: '/memory', icon: Brain, label: 'Mémoire & Graphe' },
          ...
          <div className="flex items-center justify-between px-3 pt-3 pb-2">
            ...
            >
              <img
                ...
                className="w-7 h-7 rounded-lg border border-cyan-500/40 shadow-sm shadow-cyan-500/20 object-cover group-hover:scale-105 transition-transform"
              />
              <span className="text-sm font-bold tracking-tight text-slate-100 font-mono flex items-center gap-1">
                OpenJarvis
              </span>
            </div>
